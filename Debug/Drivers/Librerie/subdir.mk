...
C_SRCS += \
../Drivers/Librerie/uart.c 

OBJS += \
./Drivers/Librerie/uart.o 

C_DEPS += \
./Drivers/Librerie/uart.d 


# Each subdirectory must supply rules for building sources it contributes
Drivers/Librerie/%.o Drivers/Librerie/%.su Drivers/Librerie/%.cyclo: ../Drivers/Librerie/%.c Drivers/Librerie/subdir.mk
...
clean: clean-Drivers-2f-Librerie

clean-Drivers-2f-Librerie:
	-$(RM) ./Drivers/Librerie/uart.cyclo ./Drivers/Librerie/uart.d ./Drivers/Librerie/uart.o ./Drivers/Librerie/uart.su

.PHONY: clean-Drivers-2f-Librerie
